    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="${cssMenu}"><a href="<spring:url value="/sample/new" htmlEscape="true" />"><span class="glyphicon glyphicon-search" aria-hidden="true"></span><span> Add Sample</span></a></li>
                <c:choose>
                    <c:when test="${name eq 'sample'}">
                        <c:set var="cssMenu" value="active"/>
                    </c:when>
                    <c:otherwise>
                        <c:set var="cssMenu" value=""/>
